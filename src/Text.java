 ...
 */
public class Text {
    public static final String NO_FILES = "No translations found. Click Settings and set proper path to dir with trans-files. Valid name for file is [lang].json - for example en.json";
